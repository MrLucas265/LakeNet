...
public class QuanOSDesktop : MonoBehaviour 
{
...
//			}
	...
	{
		//string Date = "";
		//switch (Customize.cust.DateFormat)
		//{
		//case"d/m/yy":
		//	Date = "" + ProfileController.procon.Day.ToString ("F0") + "" + "/" + ProfileController.procon.Month.ToString ("0") + "/" + ProfileController.procon.Year.ToString ("00");
		//	break;
		//case"d/mm/yy":
		//	Date = "" + ProfileController.procon.Day.ToString ("F0") + "" + "/" + ProfileController.procon.Month.ToString ("00") + "/" + ProfileController.procon.Year.ToString ("00") ;
		//	break;
		//case"dd/m/yy":
		//	Date = "" + ProfileController.procon.Day.ToString ("00") + "" + "/" + ProfileController.procon.Month.ToString ("0") + "/" + ProfileController.procon.Year.ToString ("00") ;
		//	break;
		//case"dd/mm/yy":
		//	Date = "" + ProfileController.procon.Day.ToString ("00") + "" + "/" + ProfileController.procon.Month.ToString ("00") + "/" + ProfileController.procon.Year.ToString ("00") ;
		//	break;

		//case"d/m/yyyy":
		//	Date = "" + ProfileController.procon.Day.ToString ("0") + "" + "/" + ProfileController.procon.Month.ToString ("0") + "/" + ProfileController.procon.Year.ToString ("0000") ;
		//	break;
		//case"d/mm/yyyy":
		//	Date = "" + ProfileController.procon.Day.ToString ("0") + "" + "/" + ProfileController.procon.Month.ToString ("00") + "/" + ProfileController.procon.Year.ToString ("0000") ;
		//	break;
		//case"dd/m/yyyy":
		//	Date = "" + ProfileController.procon.Day.ToString ("00") + "" + "/" + ProfileController.procon.Month.ToString ("0") + "/" + ProfileController.procon.Year.ToString ("0000") ;
		//	break;
		//case"dd/mm/yyyy":
		//	Date = "" + ProfileController.procon.Day.ToString ("00") + "" + "/" + ProfileController.procon.Month.ToString ("00") + "/" + ProfileController.procon.Year.ToString ("0000") ;
		//	break;
		//}
