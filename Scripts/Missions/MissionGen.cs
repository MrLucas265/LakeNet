   ...
   // public List<string> FilesToDelete = new List<string>();
	...
	public void FirstMission()
	{
		if (REVATestPublic.Count > 10) 
		{
			...
			GameControl.control.EmailData.Add (new EmailSystem ("Reva Test","www.reva.com",PersonController.control.Global.DateTime.FullDate,"We would like you to connect to www.reva.com/test by opening net viewer in the app menu then typing the URL in the address bar then goto the public file section find and copy this file " + DescFile +  " then reply to this email and click the @ to attach the file to the email and send it then we will give you the membership login details", null, 0, 0, 0, false,EmailSystem.EmailType.Contract));
		...
		if (DeleteMission == true) 
		{
			...
			case 1:
				EDesc = "Hey there I have a friend who said to contact you about a particuler job. Im willing to pay " + DescCash +
					" amount of credits. And all you have to do is delete this file " + DescFile + " located at this website " + DescTarget +
					" They have some kind of UAC so you might to find a password";

                MDesc = "Hey there I have a friend who said to contact you about a particuler job. Im willing to pay " + DescCash +
                    " amount of credits the files are locked behind an uac.  I'll even put in a good word for you";
			...
			case 2:
                ...
                MDesc = "Hey there I was told to contact you if I had any trouble Ill pay " + DescCash +
						" amount of credits for your work also the files are behind a user authenticator.";
