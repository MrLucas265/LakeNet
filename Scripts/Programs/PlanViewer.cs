...
public class PlanViewer : MonoBehaviour
{
   ...
   // private FileExplorer fp;
    ...
    void DoMyWindow(int windowID)
    {
        ...
        GUI.Box(new Rect(40, 2, 236, 21), "" + "Plan Viewer");
        ...
        switch (SelectedMenu)
        {
            case 0:
                ...
                if(GameControl.control.Plans.Count > 0)
                {
                    ...
                    for (scrollsize = 0; scrollsize < GameControl.control.Plans.Count; scrollsize++)
                    {
						if (SelectedNotification == scrollsize)
						{
							if (GUI.Button(new Rect(0, 22 * scrollsize, TextAreaRect.width-20, 21), "☒" + GameControl.control.Plans[scrollsize].Name))
							{
            ...
            case 2:
				...
				TypedText = GUI.TextArea(new Rect(TextAreaRect), "Company: " + GameControl.control.Plans[SelectedNotification].Company  + "\n"
                    + "URL: " + GameControl.control.Plans[SelectedNotification].URL + "\n"
                    + "Plan Name: " + GameControl.control.Plans[SelectedNotification].Name + "\n"
                    + "Details: " + GameControl.control.Plans[SelectedNotification].Note + "\n"
                    + "Plan Start Date: " + GameControl.control.Plans[SelectedNotification].Inital.TodaysDate + "\n"
                    + "Payment Due Date: " + GameControl.control.Plans[SelectedNotification].Due.TodaysDate + "\n"
                    + "Payment: " + GameControl.control.Plans[SelectedNotification].Price, 500);
                break;
            case 3:
                TextAreaRect = new Rect(115, 25, 150, 128);
                break;
