...
//						GUI.TextField (new Rect (65, 67, 200, 21), "RE: " + GameControl.control.Contracts [ContractSelect].Name);
	...
	void SendReply()
	{
		...
		if (Attachment != "") 
		{
			GameControl.control.EmailData.Add (new EmailSystem ("RE: " + GameControl.control.Contracts[ContractSelect].Name, GameControl.control.ProfileName,PersonController.control.Global.DateTime.FullDate, "Attached: " + Attachment + "\n" + Content, null, 0, 0, 0, false, EmailSystem.EmailType.Sent));
			cc.Complete();
		} 
		else 
		{
			GameControl.control.EmailData.Add (new EmailSystem ("RE: " + GameControl.control.Contracts[ContractSelect].Name,GameControl.control.ProfileName, PersonController.control.Global.DateTime.FullDate, Content, null, 0, 0, 0, false, EmailSystem.EmailType.Sent));
			cc.Complete();
		}
