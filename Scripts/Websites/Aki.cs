    ...
    public void FileSystemGenerator()
    {
        for (int i = 0; i < 1; i++)
        {
            ...
            if (FileTypePick <= 5)
            {
                ...
                {
                    GameControl.control.WebsiteFiles.Add(new ProgramSystem(FileName, "", "", "", "aki Public", "", 0, 0, FileSize, 0, 100, 0, false, ProgramSystem.ProgramType.File));
                    PublicCount++;
                }
            }
            if (FileTypePick > 5)
            {
                ...
                {
                    GameControl.control.WebsiteFiles.Add(new ProgramSystem(FileName, "", "", "", "aki Private", "", 0, 0, FileSize, 0, 100, 0, false, ProgramSystem.ProgramType.File));
                    PrivateCount++;
                }
            }
