...
//            {
//                if (GameControl.control.WebsiteFiles[i].Location == "aki Public")
//                {
//                    PublicFileCount++;
//                }

//                if (GameControl.control.WebsiteFiles[i].Location == "aki Private")
//                {
//                    PrivateFileCount++;
//                }
//                WebsiteCount++;
...
//                {
//                    GameControl.control.WebsiteFiles.Add(new ProgramSystem(FileName, "", "", "", "", "", "aki Public", "", "", "", ProgramSystem.FileExtension.File, ProgramSystem.FileExtension.Null, 0, 0, FileSize, 0, 0, 0, 0, 100, 0, 0, 0, 0, 0, 0, 0, 0, false, false, false, false, BlankInfections, BlankFileType));
//                    PublicCount++;
//                }
//            }
//            if (FileTypePick > 5)
...
//                {
//                    GameControl.control.WebsiteFiles.Add(new ProgramSystem(FileName, "", "", "", "", "", "aki Privat", "", "", "", ProgramSystem.FileExtension.File, ProgramSystem.FileExtension.Null, 0, 0, FileSize, 0, 0, 0, 0, 100, 0, 0, 0, 0, 0, 0, 0, 0, false, false, false, false, BlankInfections, BlankFileType));
//                    PrivateCount++;
//                }
//            }
...
//                {
//                    ib.AddressBar = "www.aki.com/public";
...
//                {
//                    ib.AddressBar = "www.aki.com/login";
//                    ib.showAddressBar = false;
//                    ib.ClearDirContents();
//                }
//                if (ib.Request == true)
//                {
//                    ib.ClearDirContents();
//                    clic.PastCommands.Add("www.aki.com/public");
//                    clic.PastCommands.Add("www.aki.com/login");
//                    ib.Request = false;
//                }
//                break;

//            case "www.aki.com/public":
...
//                    UsrName = "";
//                    password = "";
//                    //sm.BounceIPs.Remove(sm.akiIP);
//                    //sm.BouncedConnections.Remove(sm.akiPos);
//                    ib.AddressBar = "www.aki.com";
//                }

//                if (GUI.Button(new Rect(10, 100, 100, 20), "Temp Files"))
//                {
//                    ib.ClearDirContents();
//                    ib.AddressBar = "www.aki.com/tempfiles";
//                    //ib.DirContents.Add(GameControl.control.becassystemsPublicFileSize[scrollsize].ToString("F0"));
//                }
//                if (ib.Request == true)
//                {
//                    ib.ClearDirContents();
//                    clic.PastCommands.Add("www.aki.com");
//                    clic.PastCommands.Add("www.aki.com/tempfiles");
//                    ib.Request = false;
//                }
//                break;

//            case "www.aki.com/tempfiles":
...
//                    {
//                        if (PageFile[scrollsize].Location == "aki Public")
//                        {
...
//            case "www.aki.com/filesystem":
//                if (logged == true)
//                {
//                    FileCheck();
//                    if (GUI.Button(new Rect(5, 55, 100, 20), "Back"))
//                    {
//                        ib.AddressBar = "www.aki.com/internal";
//                    }

//                    ib.CurrentLocation = "aki Private";
...
//                    if (showMenu == true)
//                    {
//                        //					if(GUI.Button(new Rect(10, 105, 100, 20), "Delete " + GameControl.control.akiPublicFileName[Select].Name))
//                        //					{
//                        //
//                        //					}
//                        //					if(GUI.Button(new Rect(10,145,100,20),"Copy " + GameControl.control.akiPublicFileName[Select].Name))
//                        //					{
//                        //
//                        //					}
//                    }
...
//            case "www.aki.com/documents/emails":
//                if (logged == true)
//                {
...
//            case "www.aki.com/documents":
//                if (logged == true)
//                {
//                    if (GUI.Button(new Rect(10, 75, 100, 20), "Emails"))
//                    {
//                        ib.AddressBar = "www.aki.com/documents/emails";
//                    }
//                    if (GUI.Button(new Rect(10, 100, 100, 20), "Notes"))
//                    {
//                        ib.AddressBar = "www.aki.com/documents/notes";
//                    }
