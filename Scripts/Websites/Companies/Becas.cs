...
public class Becas : MonoBehaviour 
{
	...
	void Update()
	{
		...
		if (WebsiteCount <= GameControl.control.WebsiteFiles.Count)
		{
			...
			{
				if (GameControl.control.WebsiteFiles [i].Location == "Becas Public") 
				{
					PublicFileCount++;
				}

				if (GameControl.control.WebsiteFiles [i].Location == "Becas Private") 
				{
					PrivateFileCount++;
				}
				WebsiteCount++;
	...
	public void FileSystemGenerator()
	{
		for(int i=0; i<1; i++)
		{
			...
			if (FileTypePick <= 5) 
			{
				...
				{
					GameControl.control.WebsiteFiles.Add (new ProgramSystem (FileName, "", "", "", "Becas Public", "", 0, 0, FileSize, 0, 100, 0, false, ProgramSystem.ProgramType.File));
					PublicCount++;
				}
			}
			if (FileTypePick > 5) 
			{
				...
				{
					GameControl.control.WebsiteFiles.Add (new ProgramSystem (FileName, "", "", "", "Becas Private", "", 0, 0, FileSize, 0, 100, 0, false, ProgramSystem.ProgramType.File));
					PrivateCount++;
				}
			}
	...
	public void RenderSite()
	{
		...
		case "www.becassystems.com":
			...
			{
				ib.AddressBar = "www.becassystems.com/public";
			...
			{
				ib.AddressBar = "www.becassystems.com/login";
				ib.showAddressBar = false;
				ib.ClearDirContents ();
			}
			if (ib.Request == true)
			{
				ib.ClearDirContents();
				clic.PastCommands.Add ("www.becassystems.com/public");
				clic.PastCommands.Add ("www.becassystems.com/login");
				ib.Request = false;
			}
			break;

		case "www.becassystems.com/public": 
			...
			{
				ib.ClearDirContents();
				ib.AddressBar = "www.becassystems.com/tempfiles";
				//ib.DirContents.Add(GameControl.control.becassystemsPublicFileSize[scrollsize].ToString("F0"));
			}
			if (ib.Request == true)
			{
				ib.ClearDirContents();
				clic.PastCommands.Add ("www.becassystems.com");
				clic.PastCommands.Add ("www.becassystems.com/tempfiles");
				ib.Request = false;
			}
			break;

		case "www.becassystems.com/tempfiles": 
			...
			ib.CurrentLocation = "Becas Public";
			...
			if(PageFile.Count > 0)
			{
				...
				{
					if (PageFile[scrollsize].Location == "Becas Public")
					{
		...
		case "www.becassystems.com/filesystem": 
			if (logged == true)
			{
				FileCheck();
				...
				ib.CurrentLocation = "Becas Private";
		...
		case "www.becassystems.com/documents":
			if(logged == true)
			{
				if(GUI.Button(new Rect(10,75,100,20),"Emails"))
				{
					ib.AddressBar = "www.becassystems.com/documents/emails";
				}
				if(GUI.Button(new Rect(10,100,100,20),"Notes"))
				{
					ib.AddressBar = "www.becassystems.com/documents/notes";
				}
		...
		case "www.becassystems.com/internal":
			if(logged == true)
			{
				if(GUI.Button(new Rect(10,75,100,20),"File System"))
				{
					ib.AddressBar = "www.becassystems.com/filesystem";
				}
				if(GUI.Button(new Rect(10,100,100,20),"Documents"))
				{
					ib.AddressBar = "www.becassystems.com/documents";
				}
				if(GUI.Button(new Rect(10,125,100,20),"Logs"))
				{
					ib.AddressBar = "www.becassystems.com/logs";
				}
