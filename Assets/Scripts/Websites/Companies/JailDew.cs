...
public class JailDew : MonoBehaviour 
{
	...
	public void RenderSite()
	{
		...
		case "www.jaildew.com":
			...
			{
				ib.AddressBar = "www.jaildew.com/public";
			...
			{
				ib.AddressBar = "www.jaildew.com/login";
				ib.showAddressBar = false;
				ib.ClearDirContents ();
			}
			if (ib.Request == true)
			{
				ib.ClearDirContents();
				clic.PastCommands.Add ("www.jaildew.com/public");
				clic.PastCommands.Add ("www.jaildew.com/login");
				ib.Request = false;
			}
			break;

		case "www.jaildew.com/public": 
			...
			{
				ib.ClearDirContents();
				ib.AddressBar = "www.jaildew.com/tempfiles";
				//ib.DirContents.Add(GameControl.control.becassystemsPublicFileSize[scrollsize].ToString("F0"));
			}
			if (ib.Request == true)
			{
				ib.ClearDirContents();
				clic.PastCommands.Add ("www.jaildew.com");
				clic.PastCommands.Add ("www.jaildew.com/tempfiles");
				ib.Request = false;
			}
			break;

		case "www.jaildew.com/tempfiles": 
