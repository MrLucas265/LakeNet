...
public class CLICommandsV2 : MonoBehaviour
{
	...
	public void SetSystemCommands()
	{
		if(SystemCommands.Count == 0)
		{
            if(GameControl.control.ShortCommands == true)
            {
                ...
                SystemCommands.Add(new CLICMDS("noti", "noti"));
            }
            else
            {
                //PREFRENCES
                ...
                SystemCommands.Add(new CLICMDS("doubleclickdelay", "doubleclickdelay"));
                SystemCommands.Add(new CLICMDS("printinfo", "writeinfo"));
                SystemCommands.Add(new CLICMDS("systemcrash", "syscrash"));
                SystemCommands.Add(new CLICMDS("url", "url"));
                SystemCommands.Add(new CLICMDS("error", "error"));
	...
	public void CheckInput()
	{
		...
		case"aql":
            ...
            if(inputArray[1] == "aql")
            {
				PastCommands.Add("Add to QuickLaunch(aql)");
				PastCommands.Add("To add a program type");
				PastCommands.Add("The programs name example");
				PastCommands.Add("aql Calculator");
            }
            if(inputArray[1] == "cd")
            {
				PastCommands.Add("changedirectory");
				PastCommands.Add("Lets you navigate with in the terminal");
				PastCommands.Add("by either typing a filename within the working directory");
				PastCommands.Add("changedirectory Program_Files");
				PastCommands.Add("or by typing an exact filepath example");
				PastCommands.Add("changedirectory C:/Programs");
				PastCommands.Add("to see current contents type list");
            }
            if(inputArray[1] == "del")
            {
				PastCommands.Add("del");
				PastCommands.Add("allows you to delete");
				PastCommands.Add("a file in the current directory");
				PastCommands.Add("example");
				PastCommands.Add("del Test");
            }
            if(inputArray[1] == "run")
            {
            ...
            if(inputArray[1] == "pwd")
            {
				...
				PastCommands.Add("shows the current directory you are in");
            }
            if(inputArray[1] == "url")
            {
				PastCommands.Add("url opens your default browswer");
				PastCommands.Add("and enters the typed address example");
				PastCommands.Add("url www.google.com");
            }
            if(inputArray[1] == "writeinfo")
            {
				PastCommands.Add("writeinfo");
				PastCommands.Add("Is a setting to write extra info");
				PastCommands.Add("it only accepts true/false example");
				PastCommands.Add("writeinfo true");
            }
            if(inputArray[1] == "mkdir")
            {
				PastCommands.Add("makedirectory");
				PastCommands.Add("lets you create a folder");
				PastCommands.Add("in the directory your currently in");
				PastCommands.Add("example makedirectory Test");
            }
            if(inputArray[1] == "restart")
            {
				PastCommands.Add("restart");
				PastCommands.Add("This allows you to restart");
				PastCommands.Add("the gateway without using the mouse");
            }
            if(inputArray[1] == "mkdoc")
            {
				PastCommands.Add("makedocument");
				PastCommands.Add("lets you create a text file");
				PastCommands.Add("in the directory your currently in");
				PastCommands.Add("example makedocument Test");
            }
			break;
