...
public class AccSetup : MonoBehaviour
{
    ...
    const string aglyphs = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
    ...
    void Start()
    {
        ...
        SerialKey = GetRandomString(25, 25);
    ...
    void StartSetup()
    {
        ...
        GameControl.control.StoredLogins.Add(new LoginSystem("LEC Bank", GetRandomNumber(6, 6), GetRandomString1(15, 15), 0));
    ...
    public string GetRandomString1(int min, int max)
    {
        int charAmount = Random.Range(min, max);
        string retMe = "";
        for (int i = 0; i < charAmount; i++)
        {
            retMe += aglyphs[Random.Range(0, aglyphs.Length)];
        }
        return retMe;
    }
}
