...
public class GameControl : MonoBehaviour
{
    ...
    //Logins
    public List<string> LoginUser = new List<string>();
    public List<string> LoginPass = new List<string>();
    public List<string> LoginDesc = new List<string>();
    public List<string> LoginSite = new List<string>();
	...
	public void Save()
	{
        ...
        data.LoginDesc = LoginDesc;
        data.LoginSite = LoginSite;
		data.Clicks = Clicks;
		data.score = score;
